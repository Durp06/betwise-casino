 ...
 *
 * Same shared chrome (GameLobbyShell) + cream-plaque table rows as the other
 * game lobbies. 5-second auto-refresh; joining buys in (default = the table
 * minimum) and navigates to the live table.
 */
